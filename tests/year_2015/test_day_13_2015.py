...
from adventofcode.year_2015.day_13_2015 import get_seating_happiness, get_unique_persons, get_happiness_chart, \
    get_all_combinations, update_happiness_chart
...
@pytest.mark.parametrize(['value', 'expected'], [
    ...
    (['Marcel', 'Julia', 'Pixel'], [('Marcel', 'Julia'), ('Marcel', 'Pixel'), ('Julia', 'Pixel')]),
])
