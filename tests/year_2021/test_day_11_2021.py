...
from adventofcode.year_2021.day_11_2021 import part_two, part_one, Octopus, run_ticks, OctopusGrid, run_ticks_until_sync
...
@pytest.mark.parametrize(['position', 'adjacent_octopuses'], [
    ((0, 0), [(1, 0), (1, 1), (0, 1)]),
    ((0, 9), [(0, 8), (1, 8), (1, 9)]),
