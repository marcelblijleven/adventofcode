...
from adventofcode.year_2021.day_20_2021 import part_two, part_one, parse_input, get_algorithm_position_for_pixel, \
    get_algorithm_position_for_pixel_simplified, get_infinity_grid
...
@pytest.mark.parametrize(['toggles', 'default_value'], [
    (True, 1337),
    (False, 1337),
])
