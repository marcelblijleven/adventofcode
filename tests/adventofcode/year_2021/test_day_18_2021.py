...
from adventofcode.year_2021.day_18_2021 import part_two, part_one, explode, addition, parse_snailfish_number, \
    reduce_snailfish_number, parse_snailfish_numbers, calculate_magnitude, get_pair_numbers
