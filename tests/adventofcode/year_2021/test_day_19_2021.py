from adventofcode.year_2021.day_19_2021 import part_two, part_one, calculate_max_distance, AxisOffset, Scanner, \
    get_offset, apply_offset, get_scanners, process_scanners, count_unique_beacons
