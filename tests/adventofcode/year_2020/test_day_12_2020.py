...
from adventofcode.year_2020.day_12_2020 import part_two, part_one, turn, LEFT, RIGHT, NORTH, EAST, SOUTH, WEST, \
    turn_waypoint
...
@pytest.mark.parametrize(['turn_direction', 'degrees', 'current_direction', 'expected'], [
    (LEFT, 90, NORTH, WEST),
